							...
							points: flatten([
								[
									...
									this.render.toStageValue(
										this.render.rulerSize - stageState.y
									),
								],
								[
									x.value,
									this.render.toStageValue(
										this.render.rulerSize - stageState.y + stageState.height
									),
								],
							]),
					...
					this.group.add(
						new Konva.Line({
							...
							points: flatten([
								[
									this.render.toStageValue(
										this.render.rulerSize - stageState.x
									),
									y.value,
								],
								[
									this.render.toStageValue(
										this.render.rulerSize - stageState.x + stageState.width
									),
									y.value,
								],
							]),
